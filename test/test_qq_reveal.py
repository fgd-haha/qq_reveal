...
def test_is_revealed():
    ...
    assert True == qq_reveal.is_revealed(driver, '993264844@qq.com'), '993264844@qq.com 应该为已泄露账号'


def test_reveal_check():
    qq_list = {'839684679@qq.com': '前尘忆梦', 'kuaile_tiantian@qq.com': 'kuaile_tiantian'}
